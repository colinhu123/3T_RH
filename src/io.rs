...
pub fn save_data(u: &crate::field::Field, filename: &str, lx: f64, ly: f64) {
...
pub fn save_data_to(u: &crate::field::Field, final_path: &str, _lx: f64, _ly: f64) {
...
pub fn load_data(u: &mut crate::field::Field, path: &str) {
